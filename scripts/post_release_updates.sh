...
echo "Post Release Updates for $SERVER_VERSION release!"
echo
...
page_download_install_generated=src/$SERVER_VERSION_MAJOR/download-install.md
sed_bk=".bk"

# Replace placeholder occurrences
echo "<!-- Content generated. DO NOT EDIT. -->" > $page_download_install_generated
sed "s/{{RELEASE_DATE}}/$release_date/g" src/$SERVER_VERSION_MAJOR/download-install.md.tmpl >> $page_download_install_generated
