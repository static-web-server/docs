...
This feature is disabled by default and can be controlled by the boolean `--metrics` option or the equivalent [SERVER_METRICS](../configuration/env#server_metrics) env.
