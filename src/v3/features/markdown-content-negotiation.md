...
This feature is disabled by default and can be controlled by the boolean `--accept-markdown` option or the equivalent [SERVER_ACCEPT_MARKDOWN](../configuration/env#server_accept_markdown) env.
